...
export function createFairyLights(scene, emitter) {
  ...
  particles.minEmitBox = new BABYLON.Vector3(-50, -100, -50);
  particles.maxEmitBox = new BABYLON.Vector3(50, 100, 50);
  ...
  // Direction - gentle upward float
  particles.direction1 = new BABYLON.Vector3(-0.2, 0.5, -0.2);
...
export class BeanstalkEffects {
  ...
  init(plantMesh) {
    // Create fairy lights around the plant
